...
Zusammenfassend ist zu sagen, dass die Algorithmen durchaus funktionsf\"ahig sind, aber mehr Effizienz durch die oben beschriebenen Maßnahmen beziehungsweise Alternativen erreicht werden kann.

\textbf{TODO lautes rauschen entweder im Text vorher erwähnen oder löschen. Nachnahme von Angel rausfinden}

\section{Danksagung}
Die Autoren danken dem Hilfswissenschaftler Angel f\"ur die Unterst\"utzung und Hilfe bei verschiedenen Problemen mit dem Roboter und dem \textit{Robot Operating System}.
\newpage
