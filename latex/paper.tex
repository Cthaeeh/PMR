...
Es kann passieren, dass AMCL sich die Anzahl der Partikel so weit verringert, dass der Zustandsraum nur unzureichend abgedeckt wird. Stimmen die wenigen Hypothesen dann nicht mit der Realit\"at überein, verteilt er die Partikel \"uberall. Hat die Hypothese eine zu geringe Abdeckung des Zustandsraums und schafft es nicht mehr sich zu lokalisieren.
...
\begin{figure}[h]
	...
	\caption{Pfadverfolgung Odometrie}
\end{figure}
