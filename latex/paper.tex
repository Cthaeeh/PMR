...
Sie werden \"uber ein Differentialantrieb gesteuert. Dazu werden 2 feststehende Antriebsr\"ader verwendet. Es ist den Robotern also theoretisch möglich sich auf der Stelle zu drehen.
...
ROS l\"auft auf einem handels\"ublichen Notebook, dass auf den Roboter gestellt wird und \"uber LAN und USB mit dem Roboter verbunden ist. 
...
Nachteil AMCL: benö
tigt Karte, Pfad kann nicht in unbekannter Umgebung abgefahren werden
...
\begin{figure}[h]
	...
	\caption{Simulierte Pfadverfolgung}R
\end{figure}
...
\\
Neuronale Netze erm\"oglichen durch pr\"azisse Trainingsdaten einen Roboter auf verschiedene Situation vorzubereiten.
