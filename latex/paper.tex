...
\subsection{Test und Implementierung von gio path auf realem Roboter}

Um den den xyz Algorithmus auf einem realen Roboter zu testen, wird eine ROS-Node verwendet. Diese benutzt gio path um einen realen Roboter zu steuern.
 ...
 Die Autoren entscheiden sich als Testpfad eine Spirale zu nutzen. Die Datei enth\"alt Punkte in spiralf\"ormige Anordnung. 
